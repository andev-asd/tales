  ...
  await resend.emails.send({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:520px;margin:0 auto;padding:32px 16px;color:#2d2d2d">
        ...
        <a href="${url}" style="display:inline-block;background:#b86549;color:#fff;text-decoration:none;padding:12px 28px;border-radius:8px;font-weight:600;margin-bottom:24px">
          Підтвердити email
        </a>
